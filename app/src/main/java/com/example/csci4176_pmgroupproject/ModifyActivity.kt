...
class ModifyActivity : Fragment() {
    ...
    override fun onCreateView(
        ...
        val customAdapter = Activity_Adapter(arrayListOf("Blend smoothie for breakfast", "Drink 13 cups of water", "Goblet squat (6 rep x 4 sets)"))
    ...
    fun connectAdapter(recyclerView: RecyclerView, customAdapter: Activity_Adapter){
