...
import com.example.csci4176_pmgroupproject.Activities.FinishActivity
...
import com.example.csci4176_pmgroupproject.Activities.TodoItemClickListener
            ...
            startToggle?.setOnCheckedChangeListener { button, checked ->
                ...
                if (checked) {
                    button.backgroundTintList =
                        ColorStateList.valueOf(ContextCompat.getColor(itemView.context,
                            R.color.toggle_selected
                        ))
