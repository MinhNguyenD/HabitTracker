...
import com.example.csci4176_pmgroupproject.Scheduler.AlarmScheduler
import com.example.csci4176_pmgroupproject.Adapters.DailyActivityAdapter
        ...
        DatabaseAPI.getDailyActivity { dailyList ->
            if (dailyList.size <= 0) {
                ...
                if (DailyProgress.progress == 0) {
                    ...
                    DailyProgress.numActivities =
                        dailyActivityList.size + DailyProgress.numFinishedActivity.toInt()
                }
                updateProgress()
            }
        }
