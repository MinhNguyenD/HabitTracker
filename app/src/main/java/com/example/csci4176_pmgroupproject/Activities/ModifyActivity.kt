...
class ModifyActivity : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        DOWtoggles = arrayListOf(
            view.findViewById(R.id.dow_sunday),
            view.findViewById(R.id.dow_monday),
            view.findViewById(R.id.dow_tuesday),
            view.findViewById(R.id.dow_wednesday),
            view.findViewById(R.id.dow_thursday),
            view.findViewById(R.id.dow_friday),
            view.findViewById(R.id.dow_saturday)
        )
        ...
        REPtoggles = arrayListOf(
            view.findViewById(R.id.repeat_daily),
            view.findViewById(R.id.repeat_weekly),
            view.findViewById(R.id.repeat_biweekly),
            view.findViewById(R.id.repeat_triweekly),
            view.findViewById(R.id.repeat_monthly)
        )
            ...
            DatabaseAPI.getActivityById(taskId!!) { model ->
                ...
                activitySaveButton.setOnClickListener {
                    ...
                    if (repeatFrequency == ActivityModelFrequency.DAILY) {
                        ...
                        model.note = note
                        if (title.isNotEmpty() && title != model.title) {
                            model.title = title
                        }
