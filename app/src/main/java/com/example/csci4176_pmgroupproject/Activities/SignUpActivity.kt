...
class SignUpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val signupEmail: EditText = findViewById(R.id.registerEmail)
        val signUpUsername: EditText = findViewById(R.id.registerUsername)
        val signupPassword: EditText = findViewById(R.id.registerPassword)
        val signupVerifyPassword: EditText = findViewById(R.id.registerRePassword)
                ...
                if (email.isNotEmpty() && username.isNotEmpty() && pass1.isNotEmpty() && pass1 == pass2) {
                    DatabaseAPI.emailSignup(email, pass1).addOnCompleteListener { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            /**Temporary**/
                            DatabaseAPI.createUser(DatabaseAPI.currentUser.uid, username)
